...
class BoatSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $boat30 = Boat::create([
            ...
            'departure' => json_encode(['Monday - Wednesday ', 'Friday - Sunday']),
            'max_people' => 14,
            'description' => 'The Superior boat is a Superior category phinisi. Has 8 cabins for a total of 14 person. Departures on every Monday - Wednesday & Friday - Sunday.',
            'location' => 'Labuan Bajo, Indonesia',
            'year' => '2021', // Tambahkan ini
            'speed' => '7-8 Knots', // Tambahkan ini
            'width' => '4.7m', // Tambahkan ini
            'length' => '26.5m',
            'images' => json_encode([
                '/images/luxury/luxury06.jpg',
                '/images/detail/luxury06/1.jpg',
                '/images/detail/luxury06/2.jpg',
                '/images/detail/luxury06/3.jpg',
            ]),
            'itinerary' => json_encode([
                'Day 1' => [
                    'Pick up from Hotel or Airport, Transfer to Harbor, Kelor Island, Manjarite Island & Kalong Island',
        ...
        Cabin::create([
            'boat_id' => $boat30->id,
            'type' => '2 Master Cabin',
            'image' => '/images/detail/luxury06/4.jpg',
            'max_guests' => '2',
            'price_per_guest' => 10000000,
        ]);
        Cabin::create([
            'boat_id' => $boat30->id,
            'type' => '4 Deluxe Cabin',
            'image' => '/images/detail/luxury06/5.jpg',
            'max_guests' => '2',
            'price_per_guest' => 8500000,
        ]);
        $boat31 = Boat::create([
            'name' => 'Luxury 07',
            'category' => 'Luxury',
            ...
            'departure' => json_encode(['Friday - Sunday']),
            'max_people' => 18,
            'description' => 'The Superior boat is a Superior category phinisi. Has 8 cabins for a total of 18 person. Departures on every Friday - Sunday.',
            'location' => 'Labuan Bajo, Indonesia',
            'year' => '2021', // Tambahkan ini
            'speed' => '7-8 Knots', // Tambahkan ini
            'width' => '4.7m', // Tambahkan ini
            'length' => '26.5m',
            'images' => json_encode([
                '/images/luxury/luxury07.jpg',
                '/images/detail/luxury07/1.JPG',
                '/images/detail/luxury07/2.JPG',
                '/images/detail/luxury07/3.JPG',
            ]),
            'itinerary' => json_encode([
                'Day 1' => [
                    'Pick up from Hotel or Airport, Transfer to Harbor, Kelor Island, Manjarite Island & Kalong Island',
        ...
        Cabin::create([
            'boat_id' => $boat31->id,
            'type' => 'Owner Cabin',
            'image' => '/images/detail/luxury07/4.JPG',
            'max_guests' => '2-4',
            'price_per_guest' => 13000000,
        ]);
        Cabin::create([
            'boat_id' => $boat31->id,
            'type' => 'VIP Cabin',
            'image' => '/images/detail/luxury07/5.JPG',
            'max_guests' => '2',
            'price_per_guest' => 12000000,
        ]);
        Cabin::create([
            'boat_id' => $boat31->id,
            'type' => 'Master Cabin Baloncy',
            'image' => '/images/detail/luxury07/6.JPG',
            'max_guests' => '2',
            'price_per_guest' => 11000000,
        ]);
        Cabin::create([
            'boat_id' => $boat31->id,
            'type' => 'Master Cabin',
            'image' => '/images/detail/luxury07/7.JPG',
            'max_guests' => '2',
            'price_per_guest' => 9000000,
        ]);
        Cabin::create([
            'boat_id' => $boat31->id,
            'type' => 'Master Cabin',
        ...
        Cabin::create([
            'boat_id' => $boat31->id,
            'type' => '2 Deluxe Cabin',
            'image' => '/images/detail/luxury07/8.JPG',
            'max_guests' => '2',
            'price_per_guest' => 8000000,
        ]);
        Cabin::create([
            'boat_id' => $boat31->id,
            'type' => '2 Superior Cabin',
            'image' => '/images/detail/luxury07/9.JPG',
            'max_guests' => '2',
            'price_per_guest' => 6000000,
        ]);
        $boat32 = Boat::create([
            ...
            'departure' => json_encode(['Friday - Sunday']),
            'max_people' => 25,
            'description' => 'The Superior boat is a Superior category phinisi. Has 7 cabins for a total of 25 person. Departures on every Friday - Sunday.',
            'location' => 'Labuan Bajo, Indonesia',
            'year' => '2021', // Tambahkan ini
            'speed' => '7-8 Knots', // Tambahkan ini
            'width' => '4.7m', // Tambahkan ini
            'length' => '26.5m',
            'images' => json_encode([
                '/images/luxury/luxury09.jpg',
                '/images/detail/luxury09/1.jpg',
                '/images/detail/luxury09/2.jpg',
                '/images/detail/luxury09/3.jpg',
            ]),
            'itinerary' => json_encode([
                'Day 1' => [
                    'Pick up from Hotel or Airport, Transfer to Harbor, Kelor Island, Manjarite Island & Kalong Island',
        ...
        Cabin::create([
            'boat_id' => $boat32->id,
            'type' => 'Misool Cabin',
            'image' => '/images/detail/luxury09/4.JPG',
            'max_guests' => '2-3',
            'price_per_guest' => 11000000,
        ]);
        Cabin::create([
            'boat_id' => $boat32->id,
            'type' => 'Mentawai & Weh Cabin',
            'image' => '/images/detail/luxury09/5.JPG',
            'max_guests' => '2-3',
            'price_per_guest' => 8850000,
        ]);
        Cabin::create([
            'boat_id' => $boat32->id,
            'type' => 'Selayar & Route Cabin',
            'image' => '/images/detail/luxury09/6.jpg',
            'max_guests' => '2',
            'price_per_guest' => 7850000,
        ]);
        Cabin::create([
            'boat_id' => $boat32->id,
            'type' => 'Selayar & Route Cabin',
        ...
        Cabin::create([
            'boat_id' => $boat32->id,
            'type' => 'Toraja & Alor Cabin',
            'image' => '/images/detail/luxury09/7.jpg',
            'max_guests' => '2',
            'price_per_guest' => 6500000,
        ]);
        Cabin::create([
            'boat_id' => $boat32->id,
            'type' => 'Banda Neira & Savu Cabin',
            'image' => '/images/detail/luxury09/8.jpg',
            'max_guests' => '2',
            'price_per_guest' => 6500000,
        ]);
        $boat33 = Boat::create([
            ...
            'length' => '26.5m',
            'images' => json_encode([
                '/images/luxury/luxury08.jpg',
                '/images/detail/luxury08/1.jpg',
                '/images/detail/luxury08/2.jpg',
                '/images/detail/luxury08/3.jpg',
            ]),
            'itinerary' => json_encode([
                'Day 1' => [
                    'Pick up from Hotel or Airport, Transfer to Harbor, Kelor Island, Manjarite Island & Kalong Island',
        ...
        Cabin::create([
            'boat_id' => $boat33->id,
            'type' => 'Arjuna Cabin',
            'image' => '/images/detail/luxury08/4.jpg',
            'max_guests' => '2',
            'price_per_guest' => 9500000,
        ]);
        Cabin::create([
            'boat_id' => $boat33->id,
            'type' => 'Nakula Cabin',
        ...
        Cabin::create([
            ...
            'image' => '/images/detail/luxury09/7.jpg',
            'max_guests' => '2',
            'price_per_guest' => 7500000,
        ]);
        Cabin::create([
            'boat_id' => $boat33->id,
            'type' => 'Yudhistira Cabin',
            'image' => '/images/detail/luxury09/8.jpg',
            'max_guests' => '2-4',
            'price_per_guest' => 7500000,
        ]);
        $boat34 = Boat::create([
            ...
            'departure' => json_encode(['Friday - Sunday']),
            'max_people' => 18,
            'description' => 'The Superior boat is a Superior category phinisi. Has 7 cabins for a total of 18 person. Departures on every Friday - Sunday.',
            'location' => 'Labuan Bajo, Indonesia',
            'year' => '2021', // Tambahkan ini
            'speed' => '7-8 Knots', // Tambahkan ini
            'width' => '4.7m', // Tambahkan ini
            'length' => '26.5m',
            'images' => json_encode([
                '/images/luxury/luxury10.jpg',
                '/images/detail/luxury10/1.JPG',
                '/images/detail/luxury10/2.JPG',
                '/images/detail/luxury10/3.JPG',
            ]),
            'itinerary' => json_encode([
                'Day 1' => [
                    'Pick up from Hotel or Airport, Transfer to Harbor, Kelor Island, Manjarite Island & Kalong Island',
        ...
        Cabin::create([
            'boat_id' => $boat34->id,
            'type' => 'Master Cabin',
            'image' => '/images/detail/luxury10/4.JPG',
            'max_guests' => '2-4',
            'price_per_guest' => 13500000,
        ]);
        Cabin::create([
            'boat_id' => $boat34->id,
            'type' => '2 Suite Balcony',
            'image' => '/images/detail/luxury10/5.JPG',
            'max_guests' => '2-3',
            'price_per_guest' => 11000000,
        ]);
        Cabin::create([
            'boat_id' => $boat34->id,
            'type' => '4 Deluxe Cabin',
            'image' => '/images/detail/luxury10/6.JPG',
            'max_guests' => '2',
            'price_per_guest' => 7000000,
        ]);
    }
